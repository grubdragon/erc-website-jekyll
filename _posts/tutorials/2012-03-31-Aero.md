...
excerpt: Ever wondered about the reason behind the shape of F1 car? It’s Aerodynamics! In this tutorial, you would learn about the basics of Aerodynamics.
...
![Pic]({{ site.url }}/{{ page.assets-dir }}/b.png)
...
![Pic]({{ site.url }}/{{ page.assets-dir }}/d.png)
